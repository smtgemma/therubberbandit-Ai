...
class MultiImageAnalyzer:
    ...
    def _load_contract_system_prompt(self) -> str:
        ...
        gap_msrp_threshold = float(
            get_pricing_cap(pricing_caps, ("gap_dca", "msrp_threshold"))
        )
        gap_cap_under = float(
            get_pricing_cap(pricing_caps, ("gap_dca", "cap_under_threshold"))
        )
        gap_cap_over = float(
            get_pricing_cap(pricing_caps, ("gap_dca", "cap_over_threshold"))
        )
        gap_percent = float(
            get_pricing_cap(pricing_caps, ("gap_dca", "percent_under_threshold"))
        )
        vsc_percent = float(
            get_pricing_cap(pricing_caps, ("vsc", "new_under", "percent"))
        )
        vsc_cap_amount = float(
            get_pricing_cap(pricing_caps, ("vsc", "used_under", "cap"))
        )
