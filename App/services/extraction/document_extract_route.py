...
from .document_extract import extract_logo_text_anthropic
import json
...
async def extract_logo_from_document(
    ...
    """
    Extract text from logos in an uploaded document using Anthropic Claude.
    ...
    try:
        ...
        # Call Anthropic to extract logo text
        extracted_data = await extract_logo_text_anthropic(
